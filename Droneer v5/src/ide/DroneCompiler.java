...
public class DroneCompiler {
    ...
    * 
    * @param directory - path of the java file that is wanted to be compiled ( e.g
    * : "C:\Users\Name\Desktop\Test.java" )
    * 
    * @return - true if the compilation was succesfull, false if there was a
    * problem
    */
   ...
   /*
    * Method that compiles the java file at given directory, and puts the result of
    * compilation to the wanted path
    * 
    * @param directory - path of the java file that is wanted to be compiled ( e.g
    * : "C:\Users\Name\Desktop\Test.java" )
    * 
