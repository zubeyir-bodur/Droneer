	...
	{      
		...
		mainMenuPanel.getPlayButton().addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				for ( int i = 0; i < 5; i++)
					System.out.println(droneSelectMenu.getComponents()[i]);
		...
		droneSelectMenu.getPlayButton().addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e)
			{
				...
				if ( myDroneName == null )
					JOptionPane.showMessageDialog(null, "Please select your drone.", "Drone Not Selected", JOptionPane.WARNING_MESSAGE);
				else if ( enemyDroneName == null )
					JOptionPane.showMessageDialog(null, "Please select enemy drone.", "Drone Not Selected", JOptionPane.WARNING_MESSAGE);
				else
				{
...
//				droneSelectMenu.setVisible(false);
//			}
//		});
