...
public class DroneerMaster extends JFrame
{
   ...
   {      
      ...
      mainMenuPanel.settingsButton.addActionListener(new ActionListener(){
      ...
      mainMenuPanel.creditsButton.addActionListener(new ActionListener(){
      ...
      arenaMenuPanel.beginnerButton.addActionListener(new ActionListener(){
      ...
      arenaMenuPanel.sandboxButton.addActionListener(new ActionListener(){
